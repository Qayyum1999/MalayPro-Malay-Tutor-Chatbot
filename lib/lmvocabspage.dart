...
class _VocabModePageState extends State<VocabModePage> {
  ...
  Future<String> _getChatbotResponse(String user_input) async {
    ...
    var program_rules = """
        Act as if you are a Malay language teacher that only teach about Malay (Malaysia) vocabularys. 
        You can differentiate between Bahasa Malay(Malaysia) and Bahasa Malay(Indonesia).
        Only give ten words in Malay and English that related to given category.
  ...
  Widget build(BuildContext context) {
    ...
    Color chatbotbubblecolor = Color.fromARGB(255, 255, 157, 44);

    String introscript =
        "Welcome to Vocab mode! I will help you learn Malay vocabulary. Select which Vocab Category you want to learn: \n\nfood, animals, languages, directions, clothes, school, human body, travel, science, people, jobs, time, survival, colors, weather, places, shopping, etc.";
            ...
            children: [
              ...
              Padding(
                ...
                child: GestureDetector(
                  onLongPress: () {
                    context.read<MessagesNotifier>().remove_Vocab_Message();
                  },
                  child: CircleAvatar(
